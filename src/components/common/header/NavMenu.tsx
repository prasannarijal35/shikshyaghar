...
export default function NavMenu({ navbaropen }: { navbaropen: boolean }) {
  return (
    ...
    >
      <ul className="flex flex-col p-2 text-white shadow:lg md:p-0 mt-4 font-medium border border-gray-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 w-full">
