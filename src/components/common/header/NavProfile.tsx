    ...
    <>
      <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
        <div className="flex gap-2">
          <Link
            href="/login"
            className="flex justify-center items-center  px-5 py-1 border border-primary text-primary font-medium hover:text-white hover:bg-primary rounded-l-2xl rounded-r-2xl transition duration-300"
          >
            <span>Login</span>
          </Link>
