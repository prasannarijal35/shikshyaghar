...
const TeacherDirectMessageChat: React.FC = () => {
      ...
      try {
        ...
        if (!silent) {
          if (err?.response?.status === 403) {
            toast.error("This student doesn't have an active subscription");
          } else if (err?.response?.status === 404) {
            toast.error("No subscription found with this student");
          } else {
            const errorMsg =
      ...
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            You must be logged in as a teacher to access direct messages.
          </p>
        </div>
      </div>
    );
        ...
        {conversations.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <p className="text-gray-600 max-w-md mx-auto">
              You don&apos;t have any message conversations yet. Students with
              active subscriptions can message you!
            </p>
          </div>
        ) : (
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-green-100">
                          Student • {selectedConversation.otherUser.email}
                        </p>
                      </div>
                    </div>
                  </div>
...
export default TeacherDirectMessageChat;
