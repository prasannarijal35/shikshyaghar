...
const SubscriptionCard: React.FC<SubscriptionCardProps> = ({
  ...
  return (
    <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden p-4 hover:shadow-lg transition-shadow">
      {/* Header */}
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <p className="font-medium text-gray-900">
              {subscription.studentName || "No Student"}
            </p>
            <div className="flex items-center gap-1 text-sm text-gray-500">
              <Mail className="w-3 h-3" />{" "}
              {subscription.studentEmail || "No Email"}
            </div>
          </div>
        </div>
